...
% Section styling
\usepackage{titlesec}
\titleformat{\section}[leftmargin]{\raggedleft\sfamily\footnotesize\bfseries\color{BrickRed}}{}{0pt}{}
\titlespacing*{\section}{2cm}{1ex}{0.25in}

% Section styling
\usepackage{titlesec}
\titleformat{\section}[leftmargin]{\raggedleft\sffamily\footnotesize\bfseries\color{BrickRed}}{}{0pt}{}
\titlespacing*{\section}{2cm}{1ex}{0.25in}
...
\section{\color{BrickRed}research interests}
...
%
%\section{\color{BrickRed}grants and contracts}
%
%\mbox{}\vspace{-\dimexpr\baselineskip\relax}
%
%\begin{itemize}[label={}]
...
\section{\color{BrickRed}invited talks}
...
\section{\color{BrickRed}workshop presentations}
...
%% Advising
%
%\section{\color{BrickRed}advising}
%
%\mbox{}\vspace{-\dimexpr\baselineskip\relax}
%
%\vspace{\baselineskip}
...
\section{\color{BrickRed}workshops and sessions organized}
...
\section{\color{BrickRed}peer review}
...
\section{\color{BrickRed}professional experience}
